...
async function handleProxy(req) {
  ...
  // Get relative path after /api/proxy (e.g. /bluemap/Server1/ or /api/servers)
...
export async function OPTIONS() {
  return new NextResponse(null, {
    ...
    headers: {
      ...
      'Access-Control-Allow-Headers': 'Content-Type, x-target-url, bypass-tunnel-reminder, Bypass-Tunnel-Reminder',
    },
  });
}
